#
#  Be sure to run `pod spec lint ZHPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "A video player form iOS native API."
  ...
  # Or just: spec.author    = "Arex"
  # spec.authors            = { "arex" => "arex0207@aliyun.com" }
  # spec.social_media_url   = "https://twitter.com/arex"
